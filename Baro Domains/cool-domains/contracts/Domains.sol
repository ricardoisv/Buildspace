...
contract Domains is ERC721URIStorage {
  ...
  constructor(string memory _tld) ERC721("Baro Name Service", "BNS") payable {
  ...
  function register(string calldata name) public payable {
    ...
    string memory json = Base64.encode(
      abi.encodePacked(
        '{"name": "',
        _name,
        '", "description": "A domain on the Baro name service", "image": "data:image/svg+xml;base64,',
    ...
    _setTokenURI(newDomainId, "ipfs://QmNh5QFPpRzUCd45tRKsnhvv2Ds5FWwM3E6tnV85gqh5R1");
